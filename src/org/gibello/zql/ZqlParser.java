  ...
  public static void main(String args[]) throws ParseException {
    ...
    while((st = p.readStatement()) != null) {
      ...
      if(st instanceof ZQuery) { // An SQL query: query the DB
          Vector sel = ((ZQuery)st).getSelect(); // SELECT part of the query
          Vector from = ((ZQuery)st).getFrom(); 
          
          System.out.println("hello"+((ZQuery)st).toString());
          System.out.println("hello"+sel.toString());
        }
    }
